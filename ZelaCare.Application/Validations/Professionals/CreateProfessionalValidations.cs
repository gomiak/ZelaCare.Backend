...
{
    internal static class CreateProfessionalValidations
    {
        internal static ResultViewModel Validate(CreateProfessionalInputModel model)
        {
            ...
            if (model.UserId == Guid.Empty)
                result.AddError("UserId cannot be empty.");
